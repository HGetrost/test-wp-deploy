...
set :wp_user, "Heide" # The admin username
set :wp_email, "heide@uplift.global" # The admin email address
set :wp_sitename, "Test WP Deploy" # The site title
set :wp_localurl, "http://test-wp-deploy" # Your local environment URL
...
set :application, "test-wp-deploy"
set :repo_url, "git@github.com:HGetrost/test-wp-deploy.git"
set :scm, :git
